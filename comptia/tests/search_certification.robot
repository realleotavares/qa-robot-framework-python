...
Given que o usuario acessa o portal da CompTIA
    ...
    New Page       data:text/html,<html><head><title>CompTIA</title></head><body><a aria-label="Search" id="search-btn"></a><input name="q" id="search-input" /><button type="submit" id="submit-btn">Submit</button><div class="search-results" id="results"></div><script>document.getElementById('submit-btn').addEventListener('click', () => document.getElementById('results').innerText = 'Security+');</script></body></html>
